...
SET param_strict_user_04626 = 'user_04626_$';
SET enforce_strict_identifier_format = 1;
CREATE USER `user_04626_$`; -- { serverError BAD_ARGUMENTS }
CREATE USER {strict_user_04626:Identifier}; -- { serverError BAD_ARGUMENTS }
CREATE ROLE {strict_user_04626:Identifier}; -- { serverError BAD_ARGUMENTS }
GRANT SELECT ON *.* TO {strict_user_04626:Identifier}; -- { serverError BAD_ARGUMENTS }
DROP ROLE {strict_user_04626:Identifier}; -- { serverError BAD_ARGUMENTS }
...
-- RENAME TO targets remain non-parametric.
